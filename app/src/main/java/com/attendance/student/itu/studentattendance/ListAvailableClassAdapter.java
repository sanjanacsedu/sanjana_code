 ...
 */
public class ListAvailableClassAdapter  extends BaseAdapter {
    ...
    ListAvailableClassAdapter(Context context, List<SignedUpClass> listClass) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = this.inflater.inflate(R.layout.single_row1, parent, false);
