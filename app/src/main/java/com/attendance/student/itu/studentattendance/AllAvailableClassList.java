...
public class AllAvailableClassList extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_available_class_list);
        all_class_list = (ListView)findViewById(R.id.listView2);
    ...
    public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
        ...
        AlertDialog.Builder adb = new AlertDialog.Builder(
                AllAvailableClassList.this);
        adb.setTitle("Are you sure want to register for this class ?");
    ...
    class MyAsyncTask extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String result){
            ...
            Log.d("--onPostExecute--Result-----",""+result);
            ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(AllAvailableClassList.this.getApplicationContext(),android.R.layout.simple_list_item_1,TITLES);
