...
public class AllClassList extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_class_list);
        all_class_list = (ListView)findViewById(R.id.listView);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        b1.putString("course",label);


        Toast.makeText(getApplicationContext(), "coursename:"  +label, Toast.LENGTH_SHORT).show();
    ...
    class MyAsyncTask extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String result){
              ...
              Log.d("--onPostExecute--Result-----",""+result);
            ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(AllClassList.this.getApplicationContext(),android.R.layout.simple_list_item_1,TITLES);
